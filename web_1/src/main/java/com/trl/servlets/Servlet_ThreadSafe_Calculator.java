 ...
 */
@WebServlet(name = "Servlet_ThreadSafe_Calculator", urlPatterns = "/s_threadSafe_calculator")
public class Servlet_ThreadSafe_Calculator extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {

        // las variables estaticas y variables de class no son tread safe
        // variables locales son tread safe
        // Esta variable hace este servlet thread safe
