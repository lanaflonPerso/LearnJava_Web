 ...
 */
@WebServlet(name = "Servlet_VisibilityAttributes_Session_Calculator", urlPatterns = "/s_visibilityAttributes_session_calculator")
public class Servlet_VisibilityAttributes_Session_Calculator extends HttpServlet {
