...
<html>
    <head>
        ...
        <link href="../css/style_JSP_OnlineLibrary.css" rel="stylesheet" type="text/css">
    </head>
    ...
    <body>
        <div class="main">
            ...
            <div class="login_div">
                ...
                <form class="login_form" name="username" action="JSP_OnlineLibrary_SecondPage.jsp" method="POST">
