<%--
  Sources:
        1. https://www.youtube.com/watch?v=BlOw2I5v8GY&list=PLwwk4BHih4fjstwgKAHPAuUcjpRUiRh5k&index=31
--%>
...
<head>
    ...
    <link href="../css/style_JSP_ParameterTransfer_LaboratoryWork.css" rel="stylesheet" type="text/css">
</head>
...
<div class="main">
    ...
    <div class="login_div">
        ...
        <form class="login_form" name="username" action="others/main_JSP_ParameterTransfer_LaboratoryWork.jsp" method="POST">
